...
| Волна | Статус | Гейт |
|---|---|---|
| **Wave 0** — спайки S1–S6 | 🔜 готов к старту | S1–S5 зелёные на ≥2 OEM |
...
**Следующее действие:** разовый ops-setup фаундера (RuStore dev-аккаунт ИП, keystore, ключи Yandex Cloud/GigaChat, billing-sandbox, 2–3 физ-OEM) → диспетч **WAVE0-S1** автономной сессией.
<!-- STATUS:END -->
